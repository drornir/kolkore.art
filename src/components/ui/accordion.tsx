    ...
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        <ChevronDownIcon
          ...
          className="pointer-events-none ms-auto me-0 shrink-0 group-aria-expanded/accordion-trigger:hidden"
        />
        <ChevronUpIcon
          data-slot="accordion-trigger-icon"
          className="pointer-events-none ms-auto me-0 hidden shrink-0 group-aria-expanded/accordion-trigger:inline"
        />
      </AccordionPrimitive.Trigger>
