    ...
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        <ChevronDownIcon
          ...
          className="pointer-events-none shrink-0 group-aria-expanded/accordion-trigger:hidden ms-auto me-0"
        />
        <ChevronUpIcon
          data-slot="accordion-trigger-icon"
          className="pointer-events-none hidden shrink-0 group-aria-expanded/accordion-trigger:inline ms-auto me-0"
        />
      </AccordionPrimitive.Trigger>
